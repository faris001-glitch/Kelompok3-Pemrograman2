...
<form action="/barangkeluar/simpan" method="POST">
    ...
    <div class="form-group col-sm-4">
        <label for="exampleFormControlInput1">No Barang Keluar</label>
        @foreach($kas as $ks)
        ...
        <input type="text" name="no_bk" value="{{ $format }}" class="form-control" id="exampleFormControlInput1" readonly>
    </div>
    <div class="form-group col-sm-4">
    ...
    <div class="form-group col-sm-4">
        <label for="exampleFormControlInput1">Keterangan Barang Keluar</label>
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div class="card-body">
                ...
                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$bli->nm_brg}}</td>
                            <td align="center">
                                <input name="qty_bm[]" class="form-control" type="hidden" value="{{$bli->qty_bm}}" readonly>
                                <input name="harga[]" class="form-control" type="hidden" value="{{$bli->harga}}" readonly>
                                {{$bli->qty_bm}}
                            </td>
                            <td width=10%><input name="qty_bk[]" class="form-control" type="number" value="0"></td>
                            <td align="center">
                                <a href="/barangkeluar/hapus/{{$bli->kd_brg}}" onclick="return confirm('Yakin Ingin menghapus data?')" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm">
            ...
            <input type="submit" class="btn btn-primary btn-send" value="Simpan Barang Keluar">
        </div>
    </div>
</form>
@endsection